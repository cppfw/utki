...
tst::set set("tree", [](tst::suite& suite){
	...
	suite.add(
		"tree_node_value_and_initializer_list_constructor",
		[](){
			utki::tree<int> t(1,{34, 45});
			tst::check_eq(t.value, 1, [&](auto&o){o << "t.value = " << t.value;}, SL);
		}
	);

	suite.add(
		"tree_structure_construction",
		[](){
	...
	suite.add(
		...
		[](){
			...
			tst::check_eq(t.children.size(), size_t(2), SL);
			tst::check_eq(t.children[0].children.size(), size_t(2), SL);
			tst::check_eq(t.children[0].children[0].value, 34, [&](auto&o){o << "value = " << t.children[0].value;}, SL);
	...
	suite.add(
		"constructor_from_container_lvalue_lvalue",
		[](){
			...
			tst::check_eq(t.children[0].value, 10, [&](auto&o){o << "t.children[0].value = " << t.children[0].value;}, SL);
			tst::check_eq(t.children[1].value, 20, [&](auto&o){o << "t.children[1].value = " << t.children[1].value;}, SL);
		}
	);

	suite.add(
		"constructor_from_container_lvalue_rvalue",
		[](){
			typedef utki::tree<int> tree_int;
			tree_int::container_type children = {
				tree_int(10),
	...
	suite.add(
		"constructor_from_container_rvalue_rvalue",
		[](){
			...
			tst::check_eq(t.children.size(), size_t(2), [&](auto&o){o << "t.children.size() = " << t.children.size();}, SL);
			tst::check_eq(t.children[0].value, "10"s, [&](auto&o){o << "t.children[0].value = " << t.children[0].value;}, SL);
			tst::check_eq(t.children[1].value, "20"s, [&](auto&o){o << "t.children[1].value = " << t.children[1].value;}, SL);
		}
	);

	suite.add(
		"traversal_non_const_container",
		[](){
			...
			tst::check_eq(roots.begin()->value, 1, [&](auto&o){o << "roots.begin()->value = " << roots.begin()->value;}, SL);

			tst::check_eq(traversal.begin()->value, 1, [&](auto&o){o << "traversal.begin()->value = " << traversal.begin()->value;}, SL);
			...
			if(encountered != expected){
				...
				tst::check(false, [&](auto&o){o << "traversed tree is not as expected";}, SL);
			}
		}
	);

	suite.add(
		"traversal_const_container",
		[](){
			typedef utki::tree<int> tree;
	...
	suite.add(
		"traversal_non_const_container_const_iterator",
		[](){
			typedef utki::tree<int> tree;
			tree::container_type roots{
				tree(1,{34, 45}),
	...
	suite.add(
		"traversal_const_container_const_iterator",
		[](){
			typedef utki::tree<int> tree;
			const tree::container_type roots{
				tree(1,{34, 45}),
	...
	suite.add(
		"traversal_non_const_container_reverse_iterator",
		[](){
			typedef utki::tree<int> tree;
			tree::container_type roots{
				tree(1,{34, 45}),
	...
	suite.add(
		"traversal_const_container_reverse_iterator",
		[](){
			typedef utki::tree<int> tree;
			const tree::container_type roots{
				tree(1,{34, 45}),
	...
	suite.add(
		"traversal_non_const_container_const_reverse_iterator",
		[](){
			typedef utki::tree<int> tree;
			tree::container_type roots{
				tree(1,{34, 45}),
	...
	suite.add(
		"traversal_const_container_const_reverse_iterator",
		[](){
			typedef utki::tree<int> tree;
			const tree::container_type roots{
				tree(1,{34, 45}),
	...
	suite.add(
		"traversal_non_const_container_index",
		[](){
			typedef utki::tree<int> tree;
			tree::container_type roots{
				tree(1,{34, 45}),
			...
			if(index != expected){
				...
				utki::log([&](auto&o){o << std::endl;});
				tst::check(false, [&](auto&o){o << "index is not as expected";}, SL);
			}
			...
			if(index_2 != expected){
				...
				utki::log([&](auto&o){o << std::endl;});
				tst::check(false, [&](auto&o){o << "index_2 is not as expected";}, SL);
			}
		}
	);

	suite.add(
		"traversal_const_container_index",
		[](){
			typedef utki::tree<int> tree;
			const tree::container_type roots{
				tree(1,{34, 45}),
			...
			tst::check_eq(roots.begin()->value, 1, [&](auto&o){o << "roots.begin()->value = " << roots.begin()->value;}, SL);
			tst::check_eq(traversal.cbegin()->value, 1, [&](auto&o){o << "traversal.begin()->value = " << traversal.cbegin()->value;}, SL);
	...
	suite.add(
		"traversal_check_index_is_valid",
		[](){
			typedef utki::tree<int> tree;
			const tree::container_type roots{
				tree(1,{34, 45}),
	...
	suite.add(
		"traversal_operator_square_brackets",
		[](){
			typedef utki::tree<int> tree;
			const tree::container_type roots{
				tree(1,{34, 45}),
